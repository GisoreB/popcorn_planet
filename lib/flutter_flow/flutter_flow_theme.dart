...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF6F61);
  late Color secondary = const Color(0xFF3D5AFE);
  late Color tertiary = const Color(0xFFFFC107);
  late Color alternate = const Color(0xFF00C853);
  ...
  late Color accent3 = const Color(0xFFFFAB40);
  late Color accent4 = const Color(0xFF4CAF50);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFFD5006D);
  late Color accent2 = const Color(0xFF303F9F);
  late Color accent3 = const Color(0xFFFF9100);
  late Color accent4 = const Color(0xFF388E3C);
